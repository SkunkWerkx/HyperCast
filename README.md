...
- **The corpus is the contract** — `corpus/*.json` (353 vectors, seeded from the [Svartalfheim](https://github.com/NorseArchitecture/Svartalfheim) `Norse.Primitives` test suites this project descends from) replays through the Rust core's suite *and* every binding's. The C# binding replays all eleven files through real P/Invoke today.
...
rust/       the core: one cdylib, 19 cast_* exports, zero runtime dependencies
