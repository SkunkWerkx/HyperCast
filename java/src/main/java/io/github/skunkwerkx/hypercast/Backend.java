 ...
 *
 * <p>The three methods are the three ABI shapes in {@code ffi.rs}, one level below the
 ...
 * whole test suite run unchanged against either.
 */
interface Backend {
    ...
    /** The {@code (ptr, len, format, out, fault)} shape: the integer and real doors. */
